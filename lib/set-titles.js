...
export function mergeSpecialTitlesForUsername(username = '', unlockedTitles = []) {
 ...
 if (normalized === 'anibal') {
    titleMap.set('special-archeologist', {
      id: 'special-archeologist',
      source: 'special',
      tier: 'special',
      label: 'Archeologist',
      description: 'A unique honorary title for Anibal.',
      color: '#f1e1b0',
      textClass: '',
      badgeClass: 'bg-[#f1e1b0]/20 text-white border-[#f1e1b0]/40',
    });

    titleMap.set('special-team-rocket', {
      ...
      color: '#8b0000',
      textClass: '',
      badgeClass: 'bg-[#8b0000]/20 text-white border-[#8b0000]/40',
    });

   titleMap.set('special-base2', {
      id: 'special-base2',
      source: 'special',
      tier: 'special',
      label: 'Timeless Trainer',
      description: 'A unique honorary title for Anibal.',
      color: '#F0F8FF',
      textClass: '',
      badgeClass: 'bg-[#8b0000]/20 text-white border-[#8b0000]/40',
